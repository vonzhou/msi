...
<html>
  ...
  function doaction(){
	...
	function getCurrentImg(){
		var temp="";
		switch(currentMenu){
		case 1:temp="2012.jpg";break;
		case 2:temp="houtian.jpg";break;
		case 3:temp="compass.jpg";break;
		case 4:temp="mummy.jpg";break;
		case 5:temp="wujiandao.jpg";break;
		case 6:temp="biaoxingtianxia.jpg";break;
		case 7:temp="terminal.jpg";break;
		case 8:temp="harvard.jpg";break;
		case 9:temp="shengxiao.jpg";break;
		case 10:temp="jiaofu.jpg";break;
...
//ajaxUrl();
    ...
    <div id="menu">
    <div id="1" class="menu">2012</div>
  	<div id="2" class="menu">后天</div>
  	<div id="3" class="menu">黄金罗盘</div>
  	<div id="4" class="menu">木乃伊1</div>
  	<div id="5" class="menu">无间道</div>
  	<div id="6" class="menu">镖行天下前传</div>
  	<div id="7" class="menu">幸福终点站</div>
  	<div id="8" class="menu">风雨哈佛路</div>
  	<div id="9" class="menu">十二生肖</div>
  	<div id="10" class="menu">教父</div>
    </div>
