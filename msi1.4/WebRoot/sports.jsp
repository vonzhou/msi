...
<html>
  ...
  var currentImg="SportsImgs/nba.jpg";
  var base="SportsImgs/";
  var xmlHttp=null;
  ...
  function doaction(){
	...
	function getCurrentImg(){
		var temp="";
		switch(currentMenu){
		case 1:temp="nba.jpg";break;
		case 2:temp="nbazuijia.jpg";break;
		case 3:temp="ouguan.jpg";break;
		case 4:temp="yingchao.jpg";break;
		case 5:temp="gaoerfu.jpg";break;
		case 6:temp="zhongchao.jpg";break;
		case 7:temp="yijia.jpg";break;
		case 8:temp="xijia.jpg";break;
		case 9:temp="live.jpg";break;
...
//ajaxUrl();
    ...
    <div id="menu">
    <div id="1" class="menu">NBA</div>
  	<div id="2" class="menu">NBA每日最佳</div>
  	<div id="3" class="menu">欧冠</div>
  	<div id="4" class="menu">英超</div>
  	<div id="5" class="menu">高尔夫</div>
  	<div id="6" class="menu">中超</div>
  	<div id="7" class="menu">意甲</div>
  	<div id="8" class="menu">西甲</div>
  	<div id="9" class="menu">焦点直播</div>
  	<div id="10" class="menu">体育首页</div>
    </div>
