...
<html>
  ...
  <script>
  var currentMenu=6;//当前选中菜单
  var menuCount=7;//菜单数量
  var currentImg="NewsImgs/wudang.jpg";
  var base="TravelImgs/";
  var xmlHttp=null;
  ...
  function doaction(){
	...
	function getCurrentImg(){
		var temp="";
		switch(currentMenu){
		case 1:temp="sanya.jpg";break;
		case 2:temp="ifeng.jpg";break;
		case 3:temp="zhangjiajie.jpg";break;
		case 4:temp="guilin.jpg";break;
		case 5:temp="tengwang.jpg";break;
		case 6:temp="wudang.jpg";break;
		case 7:temp="travel.jpg";break;
		case 8:temp="";break;
		case 9:temp="";break;
		case 10:temp="";break;
...
//ajaxUrl();
    ...
    <div id="menu">
    <div id="1" class="menu">三亚休闲游</div>
  	<div id="2" class="menu">凤凰古城</div>
  	<div id="3" class="menu">五月张家界三日游</div>
  	<div id="4" class="menu">桂林山水</div>
  	<div id="5" class="menu">南昌滕王阁</div>
  	<div id="6" class="menu">武汉大武当</div>
  	<div id="7" class="menu">中国旅游网</div>
    </div>
